...
### Контрольная работа
Контрольная работа пройдет во время лекции 7 ноября. [Список теоретических вопросов к контрольной работе](https://github.com/nadiinchi/ml_hse_nes_2019/blob/master/materials/midterm_questions.pdf). Работа письменная, состоит из нескольких теоретических вопросов из списка и нескольких задач. 
