# Курс Машинное обучение, ВШЭ-РЭШ 2019

### Где и когда
Лекции проходят по четвергам, 12:10 - 13:30, ауд. R406.

Семинары проходят по пятницам, 10:30 - 11:50, ауд R406.

### Ссылки
Чат в telegram: https://t.me/joinchat/ABAXWBex32HOK1nCFOGikw

### Правила выставления оценок
В курсе предусмотрено несколько форм контроля знания:
* Самостоятельные работы на семинарах (СР)
* Домашние работы (на Python и теоретические) (ДЗ)
* Контрольная работа (КР)
* Письменный экзамен (Экз)

Итоговая оценка вычисляется по формуле:

O<sub>итоговая</sub> = Округление(0.15 * СР + 0.4 * ДЗ + 0.15 * КР + 0.3 * Экз)
...
### Экзамен
Экзамен пройдет 21 декабря. [Список вопросов к экзамену](https://github.com/nadiinchi/ml_hse_nes_2019/blob/master/materials/exam.pdf). Продолжительность экзамена: 1 час 20 минут. Работа письменная, состоит из нескольких теоретических вопросов из списка и нескольких задач. Пользоваться можно только калькулятором.

### Контрольная работа
Контрольная работа пройдет во время лекции 7 ноября. [Список теоретических вопросов к контрольной работе](https://github.com/nadiinchi/ml_hse_nes_2019/blob/master/materials/midterm_questions.pdf). Работа письменная, состоит из нескольких теоретических вопросов из списка и нескольких задач. Пользоваться можно только калькулятором.

### Правила сдачи домашних заданий

За каждый день просрочки дедайна по заданию - штраф -1 балл.
...
* [Курс по машинному обучению Евгения Соколова](http://wiki.cs.hse.ru/%D0%9C%D0%B0%D1%88%D0%B8%D0%BD%D0%BD%D0%BE%D0%B5_%D0%BE%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5_1)
